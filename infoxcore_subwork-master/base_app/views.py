...
def TLdashboard(request):
    if 'tlid' in request.session:
        ...
        confirm_sal = int(mem1.confirm_salary)
        print(confirm_sal)
    
        prev_mnth_lst_day = datetime.now().date().replace(day=1) - timedelta(days=1)
        prev_mnth_fst_day = prev_mnth_lst_day.replace(day=1)
        this_mnth_strt_day = datetime.now().date().replace(day=1)
        
        # sm = timedelta(days=prev_mnth_lst_day.day)
        # print(sm)
        print(prev_mnth_lst_day)
        print( prev_mnth_fst_day )
        print(this_mnth_strt_day)
        previous_sal = 0
        this_month_sal = 0
        ...
        if confirm_sal > 0 :
            ...
            # datetime.now().replace(day=1) - timedelta(days=last_day_of_prev_month.day)
            ...
            one_day_sal_pre = round((confirm_sal / working_days_pre), 2)
            ...
            previous_sal_main = round((confirm_sal - delay_sal_previous), 2)
            ...
            one_day_sal_current = round((confirm_sal / working_days_current), 2)
            ...
            this_month_sal_main = round((confirm_sal - delay_sal_current), 2)
